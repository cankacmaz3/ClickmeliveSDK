...
public class LikeLiveEventMutation: GraphQLMutation {
  ...
  public static let operationDocument: ApolloAPI.OperationDocument = .init(
    definition: .init(
      #"mutation LikeLiveEvent($liveEventId: ID!, $userId: ID!, $like: Boolean!) { likeLiveEvent(liveEventId: $liveEventId, userId: $userId, like: $like) { __typename id status type title userId description tags items thumbnailUrl replayUrl teaserUrl playbackUrl isActive totalLikeCount estimatedStartingDate startingDate endingDate createdAt updatedAt totalViewer } }"#
    ))
