...
public class OnLiveEventStatsChangeSubscription: GraphQLSubscription {
  public static let operationName: String = "OnLiveEventStatsChange"
  public static let operationDocument: ApolloAPI.OperationDocument = .init(
    definition: .init(
      #"subscription OnLiveEventStatsChange($id: ID!) { onLiveEventStatsChange(id: $id) { __typename id status type title userId description tags items thumbnailUrl replayUrl teaserUrl playbackUrl isActive totalLikeCount estimatedStartingDate startingDate endingDate createdAt updatedAt totalViewer } }"#
    ))
  ...
  public struct Data: ClickmeliveSaasAPI.SelectionSet {
    ...
    public static var __selections: [ApolloAPI.Selection] { [
      .field("onLiveEventStatsChange", OnLiveEventStatsChange?.self, arguments: ["id": .variable("id")]),
    ] }
    ...
    public var onLiveEventStatsChange: OnLiveEventStatsChange? { __data["onLiveEventStatsChange"] }

    /// OnLiveEventStatsChange
    ///
    /// Parent Type: `LiveEvent`
    public struct OnLiveEventStatsChange: ClickmeliveSaasAPI.SelectionSet {
      public let __data: DataDict
      public init(_dataDict: DataDict) { __data = _dataDict }
