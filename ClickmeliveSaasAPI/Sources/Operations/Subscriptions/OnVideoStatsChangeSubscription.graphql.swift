...
public class OnVideoStatsChangeSubscription: GraphQLSubscription {
  ...
  public static let operationDocument: ApolloAPI.OperationDocument = .init(
    definition: .init(
      #"subscription OnVideoStatsChange($id: ID!) { onVideoStatsChange(id: $id) { __typename id title description userId tags items thumbnailUrl videoUrl isActive totalLikeCount createdAt updatedAt totalViewer } }"#
    ))
